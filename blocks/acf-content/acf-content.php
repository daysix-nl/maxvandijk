...
<section class="<?php echo get_field('padding_top');?> <?php echo get_field('padding_bottom');?>">
   <div class="container grid grid-cols-1 lg:grid-cols-2 mt-[30px] xl:mt-[50px] h-fit gap-y-[16px]">
      <div class="text-editor w-full lg:w-[525px] xl:w-[538px] h-fit">
         <div class="text-16 leading-28 md:text-18 md:leading-30 lg:text-18 lg:leading-30 xl:text-18 xl:leading-30 text-white font-rubik font-normal text-editor"><?php echo get_field('tekst_1');?></div>
      </div>
      <div class="text-editor w-full lg:w-[525px] xl:w-[538px] h-fit">
         <div class="text-16 leading-28 md:text-18 md:leading-30 lg:text-18 lg:leading-30 xl:text-18 xl:leading-30 text-white font-rubik font-normal text-editor"><?php echo get_field('tekst_2');?></div>
      </div>
   </div>
</section>
<?php endif; ?>
...
<section class="<?php echo get_field('padding_top');?> <?php echo get_field('padding_bottom');?>">
   <div class="container grid grid-cols-1 lg:grid-cols-2 mt-[30px] xl:mt-[50px] h-fit gap-y-[16px]">
      ...
      <div class="w-full lg:w-[525px] xl:w-[538px] h-fit">
...
<section class="<?php echo get_field('padding_top');?> <?php echo get_field('padding_bottom');?>">
   <div class="container grid grid-cols-1 lg:grid-cols-2 mt-[30px] xl:mt-[50px] h-fit gap-y-[16px]">
      <div class="w-full lg:w-[525px] xl:w-[538px] h-fit order-2 lg:order-1">
         <div class="w-full h-[281px] md:h-[430px] lg:h-[350px] xl:h-[388px] rounded-[8px] overflow-hidden">
             <img src="<?php echo $image_url; ?>" alt="<?php echo $image_alt; ?>" class="h-full min-h-full min-w-full object-cover object-center">
         </div>
      </div>
      <div class="text-editor w-full lg:w-[525px] xl:w-[538px] h-fit order-1 lg:order-2">
         <div class="text-16 leading-28 md:text-18 md:leading-30 lg:text-18 lg:leading-30 xl:text-18 xl:leading-30 text-white font-rubik font-normal text-editor"><?php echo get_field('tekst_1');?></div>
      </div>
   </div>
</section>
